...
(cl:defmethod cl:initialize-instance :after ((m <PopulationState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PopulationState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name osrf_gear-msg:<PopulationState> is deprecated: use osrf_gear-msg:PopulationState instead.")))

...
(cl:defmethod cl:initialize-instance :after ((m <SubmitTray-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubmitTray-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name osrf_gear-srv:<SubmitTray-request> is deprecated: use osrf_gear-srv:SubmitTray-request instead.")))

(cl:ensure-generic-function 'tray_id-val :lambda-list '(m))
(cl:defmethod tray_id-val ((m <SubmitTray-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader osrf_gear-srv:tray_id-val is deprecated.  Use osrf_gear-srv:tray_id instead.")
  (tray_id m))
...
(cl:defmethod cl:initialize-instance :after ((m <SubmitTray-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubmitTray-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name osrf_gear-srv:<SubmitTray-response> is deprecated: use osrf_gear-srv:SubmitTray-response instead.")))
...
(cl:defmethod inspection_result-val ((m <SubmitTray-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader osrf_gear-srv:inspection_result-val is deprecated.  Use osrf_gear-srv:inspection_result instead.")
  (inspection_result m))

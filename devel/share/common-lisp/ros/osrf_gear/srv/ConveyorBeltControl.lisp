...
(cl:defclass <ConveyorBeltControl-request> (roslisp-msg-protocol:ros-message)
  ((state
    :reader state
    :initarg :state
    :type osrf_gear-msg:ConveyorBeltState
    :initform (cl:make-instance 'osrf_gear-msg:ConveyorBeltState)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ConveyorBeltControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConveyorBeltControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name osrf_gear-srv:<ConveyorBeltControl-request> is deprecated: use osrf_gear-srv:ConveyorBeltControl-request instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <ConveyorBeltControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader osrf_gear-srv:state-val is deprecated.  Use osrf_gear-srv:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConveyorBeltControl-request>)))
  ...
  "osrf_gear/ConveyorBeltControlRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConveyorBeltControl-request)))
  "Returns string type for a service object of type 'ConveyorBeltControl-request"
  "osrf_gear/ConveyorBeltControlRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConveyorBeltControl-request>)))
  ...
  (cl:format cl:nil "~%~%~%ConveyorBeltState state~%~%~%================================================================================~%MSG: osrf_gear/ConveyorBeltState~%# Conveyor belt state message~%float64 power    # power of the belt (percentage, in +Y direction of belt frame)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConveyorBeltControl-request)))
  "Returns full string definition for message of type 'ConveyorBeltControl-request"
  (cl:format cl:nil "~%~%~%ConveyorBeltState state~%~%~%================================================================================~%MSG: osrf_gear/ConveyorBeltState~%# Conveyor belt state message~%float64 power    # power of the belt (percentage, in +Y direction of belt frame)~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <ConveyorBeltControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConveyorBeltControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name osrf_gear-srv:<ConveyorBeltControl-response> is deprecated: use osrf_gear-srv:ConveyorBeltControl-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConveyorBeltControl-response>)))
  ...
  "osrf_gear/ConveyorBeltControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConveyorBeltControl-response)))
  "Returns string type for a service object of type 'ConveyorBeltControl-response"
  "osrf_gear/ConveyorBeltControlResponse")

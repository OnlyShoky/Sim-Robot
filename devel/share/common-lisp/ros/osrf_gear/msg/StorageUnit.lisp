...
(cl:defmethod cl:initialize-instance :after ((m <StorageUnit>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StorageUnit)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name osrf_gear-msg:<StorageUnit> is deprecated: use osrf_gear-msg:StorageUnit instead.")))

(cl:ensure-generic-function 'unit_id-val :lambda-list '(m))
(cl:defmethod unit_id-val ((m <StorageUnit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader osrf_gear-msg:unit_id-val is deprecated.  Use osrf_gear-msg:unit_id instead.")
  (unit_id m))

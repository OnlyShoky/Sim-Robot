...
(cl:defmethod cl:initialize-instance :after ((m <ConveyorBeltState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConveyorBeltState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name osrf_gear-msg:<ConveyorBeltState> is deprecated: use osrf_gear-msg:ConveyorBeltState instead.")))

(cl:ensure-generic-function 'power-val :lambda-list '(m))
(cl:defmethod power-val ((m <ConveyorBeltState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader osrf_gear-msg:power-val is deprecated.  Use osrf_gear-msg:power instead.")
  (power m))
